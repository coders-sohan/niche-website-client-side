					...
					<div className="flex flex-wrap md:text-left text-center order-first">
						...
						<div className="lg:w-1/4 md:w-1/2 w-full px-4">
							...
							<div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
								...
								<button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-red-600 border-0 py-2 px-6 focus:outline-none transition ease-linear hover:bg-red-500 rounded">
									Subscribe
								</button>
							</div>
				...
				<div className="bg-gray-900">
					<div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
						...
						<p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">
							© {Date().slice(11, 15)}{" "}
							<span className="text-red-600">MOWAT</span> —
							<a
								href="https://facebook.com/mi.sohan.02.16"

	...
	return (
		<div>
			...
			<section class="text-gray-600 body-font">
				<div class="container px-5 pt-5 pb-14 mx-auto">
					<h1 class="text-4xl font-medium title-font text-gray-900 text-center">
						Testimonials
					</h1>
						...
						<div class="p-4 md:w-1/2 w-full">
							<div class="h-full bg-gray-100 p-8 rounded">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="currentColor"
									class="block w-5 h-5 text-red-300 mb-4"
								...
								<a href="/" class="inline-flex items-center">
									...
									<span class="flex-grow flex flex-col pl-4">
										...
										<span class="text-red-500 text-sm">NewYork, USA</span>
									</span>
								</a>
							</div>
						</div>
							...
							<div class="h-full bg-gray-100 p-8 rounded">
								...
								<a href="/" class="inline-flex items-center">
									...
									<span class="flex-grow flex flex-col pl-4">
										...
										<span class="text-red-500 text-sm">London, UK</span>
									</span>
								</a>
							</div>
						</div>
